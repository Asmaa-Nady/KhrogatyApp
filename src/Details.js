    ...
    return (
      <Container>
        ...
        <Tabs tabBarUnderlineStyle={{ backgroundColor: "green" }}>
            ...
            heading={
              <TabHeading style={{ backgroundColor: "white" }}>
                <Body style={{ flexDirection: "row" }}>
                  <Image
                    source={require("./img/Khrogaty-Cuts/Icons/gabout.png")}
                    style={{
                      width: 15,
                      height: 20,
                      marginLeft: 20,
          ...
          <Tab
            heading={
              <TabHeading style={{ backgroundColor: "white" }}>
                <Body style={{ flexDirection: "row" }}>
                  <Image
                    source={require("./img/Khrogaty-Cuts/Icons/grey-map-marker.png")}
                    style={{
                      width: 15,
                      height: 20,
                      marginLeft: 20,
          ...
          >
            <Mapping mappingLocation={this.props.loctionMapping} />
          </Tab>
        </Tabs>
      </Container>
    );
