...
import { Container, Header, Content, Thumbnail, Text, Body, Card, CardItem, Spinner, Left,Button,View } from 'native-base';
import MainHeader from '../../common/MainHeader';
import MainFooter from '../../common/MainFooter';



export default class RestaurantsMMenus extends Component {
