...
import { Container,Content, Text, Body, Card, CardItem,Spinner ,Left,Button,View} from 'native-base';
import MainFooter from '../common/MainFooter';
import MainHeader from '../common/MainHeader';


export default class ThingsToDoMenus extends Component {
        ...
        return (
            <Container>
              <Content>
                ...
                <MainFooter activeThingsToDo="true"/>
            </Container>
                ...
                <Card key = {r.id}>
                  {/* <TouchableOpacity onPress={() => {
                    ...
                    <CardItem thumbnail style={{ marginTop: 10 }}>
                      ...
                      <Text style={{ fontSize: 10, color: "green" }}>{r.acf.address}</Text>
                    </View>
                        <Text note numberOfLines={3}>{r.excerpt.rendered}</Text>
                        <Button rounded success style={{height:30}} onPress={() => {
                Actions.Details({
                  "pageTitle": r.title.rendered,
                  "pageDescreption": r.content.rendered,
                  "img": r.better_featured_image.source_url,
                  ...
                  "email": r.acf.email_address
                      ...
                      <Text  style={{width:110,textAlign:"center",}}uppercase={false}>Details</Text>
                    </Button>
