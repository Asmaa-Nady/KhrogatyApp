...
import { Container, Card, Content, Text, Body, CardItem, Spinner, Input, Item, Button, View, } from 'native-base';
        ...
        return (
            <Container>
                <Content>
                    ...
                    <Card>
                        <Text style={{ fontWeight: 'bold', fontSize: 25, }}>{this.props.titlename}</Text>
                        <Text style={{ fontSize: 15, }}>{this.props.descreptionname}</Text>
                    </Card>
                    <Text style={{ fontWeight: 'bold', fontSize: 25, marginLeft: 20 }}>More Information</Text>
                    ...
                    <Text style={{ fontWeight: "bold", fontSize: 20, marginLeft: 20 }}>Leave a Comment</Text>
                    {this.renderData()}
                    ...
                    <Item>
                        ...
                        <Button transparent
                            ...
                            <Image source={require('../img/Khrogaty-Cuts/Icons/telegram.png')}
                        ...
                        <Card key={r.id}>
                            ...
                            <CardItem style={{ flexDirection: "column", alignSelf: "flex-start" }}>
                                <View style={{ flexDirection: "row", alignSelf: "flex-start" }}>
                                    ...
                                    <Text style={{marginLeft:30,marginTop:5}}>{this.TimeData(r.date)}</Text>
