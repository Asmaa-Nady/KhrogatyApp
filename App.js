...
export default class App extends Component {
  render() {
    return (
      ...
      <Scene key="OnBoarding1" component={OnBoarding1} title="OnBoarding1" type="reset" />
      <Scene key="OnBoarding2" component={OnBoarding2} title="OnBoarding2" />
      <Scene key="OnBoarding3" component={OnBoarding3} title="OnBoarding3" />

        <Scene key="Home" component={Home} title="Home" type="reset"/>
        <Scene key="Search" component={Search} title="Search"/>
        
        <Scene key="Places" component={Places} title="Places"/>
        <Scene key="PlacesMenus" component={PlacesMenus} title="PlacesMenus"/>

        <Scene key="Restaurants" component={Restaurants} title="Restaurants"/>
        <Scene key="RestaurantsMenus" component={RestaurantsMenus} title="RestaurantsMenus"/>

        <Scene key="ThingsToDo" component={ThingsToDo} title="ThingsToDo"/>
        <Scene key="ThingsToDoMenus" component={ThingsToDoMenus} title="ThingsToDoMenus"/>
        ...
        <Scene key="RestaurantsMMenus" component={RestaurantsMMenus} title="RestaurantsMMenus"/>
        <Scene key="CoffeeMenus" component={CoffeeMenus} title="CoffeeMenus"/>

        <Scene key="HeaderDetails" component={HeaderDetails} title="HeaderDetails"/>
